...
import '../../styles/Footer_Detail/ChinhSachBM.scss'

class ChinhSachBM extends React.Component {
    ...
    render() {
        ...
        return (
            <div className='CSBM'>
                ...
                <h2>CHÍNH SÁCH BẢO MẬT THÔNG TIN CÁ NHÂN CỦA KHÁCH HÀNG</h2>
                <strong>SachOnline.Com</strong> mong muốn đem lại một tiện ích mua hàng trực tuyến tin cậy, tiết kiệm và thấu hiểu người dùng. Chúng tôi nhận thấy khách hàng sử dụng website <strong>SachOnline.Com</strong> để mua sắm nhưng không phải ai cũng mong muốn chia sẻ thông tin cá nhân của mình. Chúng tôi <strong>SachOnline.Com</strong>, tôn trọng quyền riêng tư của khách hàng và cam kết bảo mật thông tin cá nhân của khách hàng khi khách hàng tin vào chúng tôi cung cấp thông tin cá nhân của khách hàng cho chúng tôi khi mua sắm tại website <strong>SachOnline.Com</strong>. Đây là nguyên tắc khi tiếp cận quyền riêng tư, thông tin cá nhân tại website <strong>SachOnline.Com</strong>.

                Chính Sách Bảo Mật Thông Tin Cá Nhân này bao gồm các nội dung:

                <br /><br />1. Sự Chấp Thuận

                <br />2. Mục Đích Thu Thập

                <br />3. Phạm Vi Thu Thập

                <br />4. Thời Gian Lưu Trữ

                <br />5. Không Chia Sẻ Thông Tin Cá Nhân Khách Hàng

                <br />6. An Toàn Dữ Liệu

                <br />7. Quyền Của Khách Hàng Đối Với Thông Tin Cá Nhân

                <br />8. Thông Tin Liên Hệ
                ...
                Thông tin cá nhân của khách hàng sẽ được lưu trữ cho đến khi khách hàng có yêu cầu hủy bỏ hoặc khách hàng tự đăng nhập và thực hiện hủy bỏ. Trong mọi trường hợp thông tin cá nhân của khách hàng sẽ được

                bảo mật trên máy chủ <strong>SachOnline.Com</strong>.

                <h2> 5. Không Chia Sẻ Thông Tin Cá Nhân Khách Hàng</h2>
                ...
                Chúng tôi có thể sử dụng dịch vụ từ một nhà cung cấp dịch vụ là bên thứ ba để thực hiện một số hoạt động liên quan đến <strong>SachOnline.Com</strong>.com và khi đó bên thứ ba này có thể truy cập hoặc xử lý các thông tin cá nhân trong quá trình cung cấp các dịch vụ đó. Chúng tôi yêu cầu các bên thứ ba này tuân thủ mọi luật lệ về bảo vệ thông tin cá nhân liên quan và các yêu cầu về an ninh liên quan đến thông tin cá nhân.
                ...
                <h2>7. Quyền Của Khách Hàng Đối Với Thông Tin Cá Nhân</h2>
                ...
                Nếu bạn có câu hỏi hoặc bất kỳ thắc mắc nào về Chính Sách này hoặc thực tế việc thu thập, quản lý thông tin cá nhân của chúng tôi, xin vui

                lòng liên hệ với chúng tôi bằng cách:

                Gọi điện thoại đến hotline: 0393816391

                Gửi thư điện tử đến địa chỉ email: toantruong10032002@gmail.com.

                <h2>9. Hiệu lực Chính Sách Bảo Mật Thông Tin Cá Nhân này có hiệu lực từ ngày 01/07/2022.</h2>

                ĐẠI DIỆN TRANG WEB <strong>SachOnline.Com</strong>.

                <br /><br />[Đã ký và đóng dấu]<br />
                <br /><br /><strong>Nguyễn Minh Ý</strong><br />
                <br />Tổng Giám Đốc
            </div>
        )
    }
